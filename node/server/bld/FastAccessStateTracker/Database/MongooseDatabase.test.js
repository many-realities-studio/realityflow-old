...
describe("ProjectOperations", () => {
    ...
    it('should find a project', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        let mockGetProject = jest.fn((project) => __awaiter(void 0, void 0, void 0, function* () {
            let p = new project_2.Project();
            p.Id = project,
                p.Description = "This is a project";
            p.ProjectName = "TestProject1";
        ...
        project_1.ProjectOperations.findProject = mockGetProject;
...
//# sourceMappingURL=MongooseDatabase.test.js.map