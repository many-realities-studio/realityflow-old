...
const behavior_1 = require("../../ORMCommands/behavior");
class TypeORMDatabase {
    ...
    static GetProject(projectId) {
        return __awaiter(this, void 0, void 0, function* () {
            let project = yield project_1.ProjectOperations.findProject(projectId);
            if (!project)
                return null;
            let objects = yield project_1.ProjectOperations.getObjects(projectId);
    ...
    static CreateBehavior(behaviorToCreate, objectId) {
        return __awaiter(this, void 0, void 0, function* () {
            yield behavior_1.BehaviorOperations.CreateBehavior(behaviorToCreate, objectId);
        });
    }
    static DeleteBehavior(objectId) {
        return __awaiter(this, void 0, void 0, function* () {
            yield behavior_1.BehaviorOperations.deleteBehavior(objectId);
        });
    }
}
