var LibraryWebSockets = {
    ...
    SocketCreate: function (url) {
        ...
        if (retWS != null) {
            ...
            console.error("Error! retWS is null");
        }

        //	socket.socket.binaryType = 'arraybuffer';
        socket.socket.addEventListener('message', function (e) {
        ...
        socket.socket.addEventListener('close', function (e) {
            if (e.code != 1000) {
