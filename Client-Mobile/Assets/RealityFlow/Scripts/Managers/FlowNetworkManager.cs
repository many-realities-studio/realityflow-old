...
public class FlowNetworkManager : MonoBehaviour
{
    ...
    public const int CLIENT_MOBILE = 2;
    public const int CLIENT_HOLOLENS = 3;
    public const int CLIENT_RIPPLE = 4; // unclear on what this is; this value was originally 2, but was changed due
                                        // to what seemed to be conflicts with mobile reference values
...
//            WULogin.onLoggedIn += OnLoggedIn;
        ...
        // Mobile 
        else if (clientType == CLIENT_MOBILE)
        {
            mainGameCamera.SetActive(true);
        }
