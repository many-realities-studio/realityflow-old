...
namespace RuntimeGizmos
{
	...
	public class TransformGizmo : MonoBehaviour
	{
        ...
        //ObservableCollection<Transform> observableTargets = new ObservableCollection<Transform>();
        ...
        // NOTE: edited this to check if a GUI element is being clicked
        void GetTarget()
		{
		...
		void AddTargetRoot(Transform targetRoot)
		{
            ...
            //observableTargets.Add(targetRoot);
            //outlinerManager.selectedInWorld(targetRoot);
		...
		void RemoveTargetRoot(Transform targetRoot)
		{
			if(targetRoots.Remove(targetRoot))
			{
                ...
                //observableTargets.Remove(targetRoot);
                //outlinerManager.selectedInWorld(targetRoot);
        ...
        // NOTE (Jon): I added this to check if an object is selected. It's referenced in ApplyColor.cs
        public bool isSelected(Transform t)
        {
            if (targetRoots.ContainsKey(t)) return true;
            return false;
        }
	}
}
