...
class Room {
    ...
    updateAvatar(AvatarToUpdate, client) {
        let success = this._CurrentProject.UpdateFAMAvatar(AvatarToUpdate, client);
        return success;
    }
    updateBehaviour(BehaviourToUpdate, client) {
    ...
    ReadNodeView(nodeGUID) {
        return this._CurrentProject.GetNodeView(nodeGUID);
    }
    updateNodeView(nodeViewToUpdate, client) {
