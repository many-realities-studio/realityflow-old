...
class ProjectOperations {
    ...
    static findProjectShortCode(projectId) {
        return __awaiter(this, void 0, void 0, function* () {
            let project = yield typeorm_1.getConnection(process.env.NODE_ENV).createQueryBuilder().
                select("project").
                from(project_1.Project, "project").
    ...
    static getObjects(projectId) {
        return __awaiter(this, void 0, void 0, function* () {
            let objects = yield typeorm_1.getConnection(process.env.NODE_ENV).createQueryBuilder()
                .select("object")
    ...
    static getVSGraphs(projectId) {
        return __awaiter(this, void 0, void 0, function* () {
            let vsGraphs = yield typeorm_1.getConnection(process.env.NODE_ENV).createQueryBuilder()
                .select("vsgraph")
